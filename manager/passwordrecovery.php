...
$query="select * from manager where email='$email'and phone='$cellno'";
...
cerror.innerHTML="<span style='color:rgb(112,3,94);''>"+" field should not be empty*</span>"
error.innerHTML="<span style='color:rgb(112,3,94);''>"+" field should not be empty *</span>"
errormessage.innerHTML="<span style='color:rgb(112,3,94);''>"+" field should not be empty *</span>"
...
if(cellno.substring(0,3)!='071'&& cellno.substring(0,3)!='072'&&
 ...
 cerror.innerHTML="<span style='color:rgb(112,3,94);''>"+" Begin of the Mobile phone number invalid. *</span>"
    return false;
...
cerror.innerHTML="<span style='color:rgb(112,3,94);''>"+" Mobile Phone number must start with 0.*</span>";
return false;
}
else
if(!cellno.match(/^[0-9]+$/))
...
cerror.innerHTML="<span style='color:rgb(112,3,94);''>"+"field should be filled with number only.*</span>";
return false;   
}
else
if(cellno.toString().length!=10)
{
cerror.innerHTML="<span style='color:rgb(112,3,94);''>"+"field should be 10 characters.*</span>";    
...
{
error.innerHTML="<span style='color:rgb(112,3,94);''>"+" Invalid email.*</span>";
...
if(!pass.match(/^(?=.*[a-z])/))
{
  errormessage.innerHTML="<span style='color:rgb(112,3,94);''>"+" Password should contain atleast 1 lowercase alphabetical character.*</span>";
return false;
}
else
{
...
if(!pass.match(/^(?=.*[A-Z])/))
{
  errormessage.innerHTML="<span style='color:rgb(112,3,94);''>"+" Password should contain atleast 1 uppercase alphabetical character.*</span>";
return false;
}
else
{
...
if(!pass.match(/^(?=.*[0-9])/))
{
  errormessage.innerHTML="<span style='color:rgb(112,3,94);''>"+" Password should contain atleast 1 numeric character.*</span>"
return false;
}
else
{
...
if(!pass.match(/^(?=.*[!@#\$%\^&\*])/))
{
  errormessage.innerHTML="<span style='color:rgb(112,3,94);''>"+" Password should contain special character.*</span>";
return false;
}
else
{
...
if(!pass.match(/^(?=.{8,})/))
{
  errormessage.innerHTML="<span style='color:rgb(112,3,94);''>"+" Password shouldcontain 8 or more characters.*</span>";
return false;
}
else
{
...
cerrormessage.innerHTML="<span style='color:rgb(112,3,94);''>"+" confirm Password.*</span>";
return false;   
}else
{
...
errormessage.innerHTML="<span style='color:rgb(112,3,94);''>"+" Password doesnt match.*</span>"
cerrormessage.innerHTML="<span style='color:rgb(112,3,94);''>"+" Password doesnt match.*</span>"
return false;   
}else
{
errormessage.innerHTML=""
        ...
        <div class="d-flex flex-column justify-content-center" data-aos="fade-up-right" id="login-box">
            ...
            <div class="email-login" style="background-color:#ffffff;">
                ...
                <div style="padding-top: 15px;">
                    ...
                    <span id="gerror"></span>
                </div><input type="text" name="phone" id="phone" class="email-imput form-control" style="margin-top: 10px;border-top-color: rgb(255,255,255);border-right-color: rgb(255,255,255);border-bottom-color: rgb(112,3,94);border-left-color: rgb(255,255,255);"  placeholder="Phone" ><span id="cerror"></span>
                      <input type="email" name="email" id="email" class="email-imput form-control" style="margin-top: 10px;border-top-color: rgb(255,255,255);border-right-color: rgb(255,255,255);border-bottom-color: rgb(112,3,94);border-left-color: rgb(255,255,255);"  placeholder="Email" ><span id="error"></span>
                      <input type="password" name="password" id="password" class="password-input form-control" style="margin-top: 10px;border-top-color: rgb(255,255,255);border-right-color: rgb(255,255,255);border-bottom-color: rgb(112,3,94);border-left-color: rgb(255,255,255);"  placeholder="New Password" ><span id="errorpass"></span>
                      <input type="password" name="cpassword" id="cpassword" class="password-input form-control" style="margin-top: 10px;border-top-color: rgb(255,255,255);border-right-color: rgb(255,255,255);border-bottom-color: rgb(112,3,94);border-left-color: rgb(255,255,255);"  placeholder="Comfirm New Password" ><span id="cerrorpass"></span>
            </div>
            <div class="submit-row" style="margin-bottom:8px;padding-top:0px;">
            <input class="btn btn-primary btn-block box-shadow" id="submit-id-submit" type="submit" name="save" value="Save Password" style="background: rgb(112,3,94);"></div>
