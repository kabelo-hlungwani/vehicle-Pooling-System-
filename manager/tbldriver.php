...
<body id="page-top">
        ...
        <div id="wrapper">
            <div class="d-flex flex-column" id="content-wrapper">
              ...
              $query="SELECT * from driver,driver_license_detail where driver.driver_id=driver_license_detail.driver_id";
                    ...
                    <div class="container-fluid">
                        <div class="card shadow">
                            <div class="card-header py-3">
                                <p class="m-0 font-weight-bold" style="color: rgb(75,2,59);border-color: rgb(75,2,59);">Drivers</p>
                            </div>
                            <div class="card-body">
                                <section class="mt-4">
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="form-group pull-right col-lg-4"><input type="text" class="search form-control" placeholder="Search by Name."></div><span class="counter pull-right"></span>
