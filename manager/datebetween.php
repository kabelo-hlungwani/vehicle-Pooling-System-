...
<body id="page-top">
    ...
    <button class="btn btn"style="background-color:#4b023b;color:white;" style="font-family: Asap, sans-serif;color:rgb(255,255,255);" type="submit" placeholder="Search Here" value="Retrieve data" style="height:35px;"><i class="fas fa-spinner"></i> Retrieve data</button>&nbsp;
                    ...
                    <div class="container-fluid">
                        <div class="card shadow">
                            <div class="card-header py-3">
                                <p class="m-0 font-weight-bold" style="color: #4b023b;">Report between ( <?php echo $datebegan; ?> and <?php echo $lastdate; ?> )</p>
                            </div>
...
<a class="btn btn" style="background-color:#4b023b;color:rgb(255,255,255)" href="report.php"> <i class="fa fa-arrow-left"></i> Back</a>
