...
<head>
    ...
    <title>Managers</title><link rel="icon" href="assets/img/carlogo.png">
                    ...
                    <div class="container-fluid">
                        <div class="card shadow">
                            <div class="card-header py-3">
                                <p class="m-0 font-weight-bold" style="color:  rgb(21,132,38);">Managers</p>
                            </div>
                                                        ...
                                                        <tbody>
                                                          ...
                                                          ?>
                                                            <tr>
                                                                ...
                                                                <td><a class="btn btn-danger btn-sm border-white" title="Edit Manager" href="editManagers.php?edt=<?php echo $rows['manager_id'];?>" style="margin-left: 5px;background: rgb(21,132,38);" type="submit"><i class="fa fa-edit"></i></a>
                                                                <a class="btn btn-danger btn-sm border-white" title="Delete Manager" href="delmanagers.php?edt=<?php echo $rows['manager_id'];?>" style="margin-left: 5px;background: rgb(21,132,38)" type="submit"><i class="fa fa-trash"></i></a></td>
                                                            </tr>
