...
$query="select * from fleet_officer where email='$email' and username='$username'";
...
if(strtolower($row['email'])==strtolower($email) && $row['username']==$username)
{


 echo '<script type="text/javascript">alert("user Account exist."); window.location = "officers.php";</script>';

}                         
else{

$sql="INSERT INTO fleet_officer(first_name, middle_name,last_name,gender, phone, email,username,password) 
            VALUES ('$fname','$mname','$lname','$gender','$phone','$email','$username',MD5('$password'))";
  ...
  $name = $fname.' '.$lname;
  $email = $email;
  $subject = 'Fleet Officer Account.';
  $body = 'Your Username is '.$username.' & Password is '.$password;
  ...
  $mail->SMTPAuth = true;
  $mail->Username = "vehiclepoolingsystem21@gmail.com";
  ...
  if ($mail->send()) {
    ...
    echo '<script type="text/javascript">alert("Officer Account Succesfully created."); window.location = "officers.php";</script>';
  } else {
      $status = "failed";
    ...
    <div class="container" style="height: 477.676px;">
        ...
        <div class="d-flex flex-column justify-content-center" data-aos="fade-up-right" id="login-box">
            <div class="login-box-header" style="background: rgb(21,132,38);">
                <h4 style="color: rgb(255,255,255);margin-bottom: 0px;font-weight: 400;font-size: 27px;">Add Officer</h4>
            </div>
            
            <div class="login-box-content"></div>
            <div class="email-login" style="background-color:#ffffff;">
         
                <input type="text" name="fname" id="fname" class="email-imput form-control" style="margin-top: 10px;border-top-color: rgb(255,255,255);border-right-color: rgb(255,255,255);border-bottom-color: rgb(21,132,38);border-left-color: rgb(255,255,255);"  placeholder="First Name" ><span id="ferror"></span>
                <input type="text" name="mname" id="mname" class="email-imput form-control" style="margin-top: 10px;border-top-color: rgb(255,255,255);border-right-color: rgb(255,255,255);border-bottom-color: rgb(21,132,38);border-left-color: rgb(255,255,255);"  placeholder="Middle Name (Optional)" ><span id="merror"></span>
                <input type="text" name="lname" id="lname" class="email-imput form-control" style="margin-top: 10px;border-top-color: rgb(255,255,255);border-right-color: rgb(255,255,255);border-bottom-color: rgb(21,132,38);border-left-color: rgb(255,255,255);"  placeholder="Last Name" ><span id="lerror"></span>
                ...
                <div style="padding-top: 15px;"><label >Gender</label>
                    ...
                    <span id="gerror"></span>
                </div><input type="text" name="phone" id="phone" class="email-imput form-control" style="margin-top: 10px;border-top-color: rgb(255,255,255);border-right-color: rgb(255,255,255);border-bottom-color: rgb(21,132,38);border-left-color: rgb(255,255,255);"  placeholder="Phone" ><span id="cerror"></span>
                      <input type="email" name="email" id="email" class="email-imput form-control" style="margin-top: 10px;border-top-color: rgb(255,255,255);border-right-color: rgb(255,255,255);border-bottom-color: rgb(21,132,38);border-left-color: rgb(255,255,255);"  placeholder="Email" ><span id="error"></span>
                      <input type="text" name="username" id="username" class="email-imput form-control" style="margin-top: 10px;border-top-color: rgb(255,255,255);border-right-color: rgb(255,255,255);border-bottom-color: rgb(21,132,38);border-left-color: rgb(255,255,255);"  placeholder="Username" ><span id="uerror"></span>
                      
            </div>
            <div class="submit-row" style="margin-bottom:8px;padding-top:0px;">
            <button class="btn btn-primary btn-block box-shadow" id="submit-id-submit" type="submit" name="register" value="Add" style="background: rgb(21,132,38);"><i class="fas fa-plus-circle    "></i> Add</button></div>
            <div id="login-box-footer" style="padding: 10px 20px;padding-bottom: 23px;padding-top: 18px;background: rgb(21,132,38);">
                <p style="margin-bottom: 0px;color: rgb(255,255,255);"><a id="register-link" href="dash-master.php" style="color: rgb(255,255,255);"><i class="fas fa-arrow-left    "></i> Back</a></p>
            </div>
        </div>
</form>
    </div>
