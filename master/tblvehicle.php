    ...
    <div class="container">
        <div id="wrapper">
            <div class="d-flex flex-column" id="content-wrapper">
                    ...
                    <div class="container-fluid">
                        <div class="card shadow">
                            <div class="card-header py-3">
                                <p class="m-0 font-weight-bold" style="color:  rgb(27,152,242);">Cars Available</p>
                            </div>
              ...
              $query="SELECT * from vehicle where officer_id='$id'";
                                                    ...
                                                    <table class="table table-bordered table-hover">
                                                        <thead class="bill-header cs" style="background: rgb(27,152,242);">
                                                            <tr>
                                                                ...
                                                                <th id="trs-hd" class="col-lg-2"><i class="fa fa-cog"></i></th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                          ...
                                                          ?>
                                                            <tr>
                                                                ...
                                                                <td><img src="cars/<?php echo $rows['image'];?>" style="width: 150px;height:75px;"></td>
                                                                <td><?php echo $rows['mileage'];  ?></td>
                                                                <td><?php echo $rows['fueltype'];  ?></td>
                                                               
                                                                <td><a class="btn btn-success btn-sm bg-white" href="editvehicle.php?edt=<?php echo $rows['vehicle_id'];?>" style="margin-left: 5px;background: rgb(255,255,255);border-top-color: rgb(255,255,255);border-right-color: rgb(255,255,255);border-bottom-color: rgb(255,255,255);border-left-color: rgb(255,255,255);" type="submit"><i class="fa fa-edit" style="font-size: 15px;color: rgb(27,152,242);"></i></a>
                                                                <a class="btn btn-danger btn-sm border-white" href="delvehicle.php?edt=<?php echo $rows['vehicle_id'];?>" style="margin-left: 5px;background: rgb(255,255,255);" type="submit"><i class="fa fa-trash" style="font-size: 15px;color: rgb(255,6,6);"></i></a></td>
                                                            </tr>
