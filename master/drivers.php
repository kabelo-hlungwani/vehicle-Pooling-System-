...
<head>
    ...
    <title>Drivers</title><link rel="icon" href="assets/img/carlogo.png">
...
<body id="page-top">
        ...
        <div id="wrapper">
                    ...
                    <div class="container-fluid">
                        <div class="card shadow">
                            <div class="card-header py-3">
                                <p class="m-0 font-weight-bold" style="color:  rgb(21,132,38);">Drivers</p>
                            </div>
                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-md-12 search-table-col" style="margin-top: 0px;font-family: Montserrat, sans-serif;font-size: 13px;">
                                                <div class="form-group pull-right col-lg-4"><input type="text" class="search form-control" placeholder="Search by Name or Surname."></div><span class="counter pull-right"></span>
                                                        ...
                                                        <tbody>
                                                          ...
                                                          ?>
                                                            <tr>
                                                                ...
                                                                <td><a class="btn btn-danger btn-sm border-white" title="Edit Driver" href="editDrivers.php?edt=<?php echo $rows['driver_id'];?>" style="margin-left: 5px;background: rgb(21,132,38);" type="submit"><i class="fa fa-edit"></i></a>
                                                                <a class="btn btn-danger btn-sm border-white" title="Delete Driver" href="deldrivers.php?edt=<?php echo $rows['driver_id'];?>" style="margin-left: 5px;background: rgb(21,132,38);" type="submit"><i class="fa fa-trash"></i></a></td>
                                                            </tr>
            ...
            <a class="btn btn-primary" style="background-color:rgb(21,132,38);" href="dash-master.php"> <i class="fa fa-arrow-left"></i> Back</a>
