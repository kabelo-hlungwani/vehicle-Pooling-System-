...
$query="select * from driver where email='$email' and username='$username'";
...
if(strtolower($row['email'])==strtolower($email) && $row['username']==$username)
{
 ...
 echo '<script type="text/javascript">alert("Account exist."); window.location = "drivers.php";</script>';

}                         
else{

$sql="INSERT INTO driver(first_name, middle_name,last_name,gender, phone, email,username,password) 
  ...
  if ($mail->send()) {
    ...
    echo '<script type="text/javascript">alert("Driver Account Succesfully created."); window.location = "drivers.php";</script>';
  } else {
      $status = "failed";
    ...
    <div class="container" style="height: 477.676px;">
        ...
        <div class="d-flex flex-column justify-content-center" data-aos="fade-up-right" id="login-box">
            <div class="login-box-header" style="background: rgb(21,132,38);">
                <h4 style="color: rgb(255,255,255);margin-bottom: 0px;font-weight: 400;font-size: 27px;">Add Driver</h4>
            </div>
