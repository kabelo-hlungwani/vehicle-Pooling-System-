...
echo '<script>alert(" Fleet Officer information Updated.");window.location = "officers.php";</script>';
    ...
    <div class="container" style="height: 477.676px;">
        ...
        <div class="d-flex flex-column justify-content-center" data-aos="fade-up-right" id="login-box">
            <div class="login-box-header" style="background: rgb(21,132,38);">
                <h4 style="color: rgb(255,255,255);margin-bottom: 0px;font-weight: 400;font-size: 27px;">Update Fleet officer Details</h4>
            </div>
            ...
            <div id="login-box-footer" style="padding: 10px 20px;padding-bottom: 23px;padding-top: 18px;background: rgb(21,132,38);">
                <p style="margin-bottom: 0px;color: rgb(255,255,255);"><a id="register-link" href="officers.php" style="color: rgb(255,255,255);">Back</a></p>
            </div>
        </div>
</form>
    </div>
