...
$query="select * from manager where email='$email' and username='$username'";
...
if(strtolower($row['email'])==strtolower($email) && $row['username']==$username)
{
 ...
 echo '<script type="text/javascript">alert("Account exist."); window.location = "managers.php";</script>';

}                         
else{

$sql="INSERT INTO manager(first_name, middle_name,last_name,gender, phone, email,username,password) 
  ...
  if ($mail->send()) {
    ...
    echo '<script type="text/javascript">alert("Manager Account Succesfully created."); window.location = "managers.php";</script>';
  } else {
      $status = "failed";
    ...
    <div class="container" style="height: 477.676px;">
        ...
        <div class="d-flex flex-column justify-content-center" data-aos="fade-up-right" id="login-box">
            <div class="login-box-header" style="background: rgb(21,132,38);">
                <h4 style="color: rgb(255,255,255);margin-bottom: 0px;font-weight: 400;font-size: 27px;">Add Manager</h4>
            </div>
            ...
            <div id="login-box-footer" style="padding: 10px 20px;padding-bottom: 23px;padding-top: 18px;background: rgb(21,132,38);">
                <p style="margin-bottom: 0px;color: rgb(255,255,255);"><a id="register-link" href="dash-master.php" style="color: rgb(255,255,255);"><i class="fa fa-arrow-left    "></i> Back</a></p>
            </div>
        </div>
</form>
    </div>
