...
$query="select * from master where email='$email'and phone='$cellno'";
...
errormessage.innerHTML="<span style='color:rgb(21,132,38);''>"+" field should not be empty *</span>"
...
if(!pass.match(/^(?=.*[a-z])/))
{
  errormessage.innerHTML="<span style='color:rgb(21,132,38);''>"+" Password should contain atleast 1 lowercase alphabetical character.*</span>";
return false;
}
else
{
...
if(!pass.match(/^(?=.*[A-Z])/))
{
  errormessage.innerHTML="<span style='color:rgb(21,132,38);''>"+" Password should contain atleast 1 uppercase alphabetical character.*</span>";
return false;
}
else
{
...
if(!pass.match(/^(?=.*[0-9])/))
{
  errormessage.innerHTML="<span style='color:rgb(21,132,38);''>"+" Password should contain atleast 1 numeric character.*</span>"
return false;
}
else
{
...
if(!pass.match(/^(?=.*[!@#\$%\^&\*])/))
{
  errormessage.innerHTML="<span style='color:rgb(21,132,38);''>"+" Password should contain special character.*</span>";
return false;
}
else
{
...
if(!pass.match(/^(?=.{8,})/))
{
  errormessage.innerHTML="<span style='color:rgb(21,132,38);''>"+" Password shouldcontain 8 or more characters.*</span>";
return false;
}
else
{
...
cerrormessage.innerHTML="<span style='color:rgb(21,132,38);''>"+" confirm Password.*</span>";
return false;   
}else
{
...
errormessage.innerHTML="<span style='color:rgb(21,132,38);''>"+" Password doesnt match.*</span>"
cerrormessage.innerHTML="<span style='color:rgb(21,132,38);''>"+" Password doesnt match.*</span>"
return false;   
}else
{
errormessage.innerHTML=""
...
<body style="background: rgb(255,255,255);font-family: Montserrat, sans-serif;">
    <nav class="navbar navbar-light navbar-expand-md navigation-clean-button">
        <div class="container"><a class="navbar-brand" href="../index.php" style="color: rgb(21,132,38);">VPS&nbsp;<i class="fas fa-car-alt"></i></a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
    ...
    <div class="container" style="height: 477.676px;">
        <hr style="background: rgb(21,132,38);">
            ...
            <div class="email-login" style="background-color:#ffffff;">
                ...
                <div style="padding-top: 15px;">
                    ...
                    <span id="gerror"></span>
                      ...
                      <input type="password" name="password" id="password" class="password-input form-control" style="margin-top: 10px;border-top-color: rgb(255,255,255);border-right-color: rgb(255,255,255);border-bottom-color: rgb(21,132,38);border-left-color: rgb(255,255,255);"  placeholder="New Password" ><span id="errorpass"></span>
                      <input type="password" name="cpassword" id="cpassword" class="password-input form-control" style="margin-top: 10px;border-top-color: rgb(255,255,255);border-right-color: rgb(255,255,255);border-bottom-color: rgb(21,132,38);border-left-color: rgb(255,255,255);"  placeholder="Comfirm New Password" ><span id="cerrorpass"></span>
            </div>
            <div class="submit-row" style="margin-bottom:8px;padding-top:0px;">
            <input class="btn btn-primary btn-block box-shadow" id="submit-id-submit" type="submit" name="save" value="Save Password" style="background: rgb(21,132,38);"></div>
