...
$qry=mysqli_query($conn,"select * from master WHERE master_id='$id'");
...
echo '<script>alert("Information Updated.");window.location = "dash-master.php";</script>';
...
<head>
    ...
    <title>Profile - Brand</title><link rel="icon" href="assets/img/carlogo.png">
            ...
            <div class="d-flex flex-column" id="content-wrapper">
                <div id="content">
                    <nav class="navbar navbar-light navbar-expand shadow mb-4 topbar static-top" style="background: #ffffff;">
                        <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button><a href="dash-master.php" style="font-weight: 600;color: rgb(21,132,38);">Back To Account</a>
                            <ul class="navbar-nav flex-nowrap ml-auto">
                                ...
                                <li class="nav-item dropdown no-arrow">
                                    <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-toggle="dropdown" href="profile.php"><span class="text-white d-none d-lg-inline mr-2 text-gray-600 small" style="color: rgb(21,132,38);font-size: 16px;"><?php echo $data['last_name'].' '.$data['first_name'] ?></span><i class="far fa-user-circle" style="font-size: 28px;color: rgb(21,132,38);"></i></a>
                                    ...
                                    <div class="col">
                                        <div class="card shadow mb-3">
                                            <div class="card-header py-3">
                                                <p class="m-0 font-weight-bold" style="color: rgb(21,132,38);">User Information</p>
                                            </div>
                                            <div class="card-body">
                                                <form  action="" name="form" onsubmit="return validateForm();" method="post">
                                                    ...
                                                    <div class="form-group"><button class="btn btn-sm" type="submit" name="update" style="background: rgb(21,132,38);color: rgb(255,255,255);">Save Information&nbsp;</button></div>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
