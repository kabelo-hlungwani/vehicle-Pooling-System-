...
<head>
    ...
    <title>VPS-Report(taken Vehicles)</title><link rel="icon" href="assets/img/carlogo.png">
                    ...
                    <div class="container-fluid">
                        <div class="card shadow">
                            <div class="card-header py-3">
                                <p class="m-0 font-weight-bold" style="color: rgb(27,152,242);">Taken Vehicles</p>
                            </div>
                                                        ...
                                                        <tbody>
                                                          ...
                                                          ?>
                                                           <tr>
                                                                ...
                                                                <td><?php  if($rows['status']=='1'){ echo 'Not Available.';}else{ echo 'Available';}  ?></td>
