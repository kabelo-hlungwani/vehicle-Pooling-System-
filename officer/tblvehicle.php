                                                        ...
                                                        <tbody>
                                                          ...
                                                          ?>
                                                            <tr>
                                                                ...
                                                                <td><?php echo number_format($rows['mileage'],2);  ?>KM</td>
                                                                <td><?php echo number_format($rows['max_mileage'],2);  ?>KM</td>
                                                                <td><?php echo $rows['fueltype'];  ?></td>
                                                               
                                                                <td><a class="btn btn-danger btn-sm border-white" href="editvehicle.php?edt=<?php echo $rows['vehicle_id'];?>" style="margin-left: 5px;background: rgb(27,152,242);" type="submit"><i class="fa fa-edit"></i></a>
                                                                <a class="btn btn-danger btn-sm border-white" href="delvehicle.php?edt=<?php echo $rows['vehicle_id'];?>" style="margin-left: 5px;background: rgb(27,152,242);" type="submit"><i class="fa fa-trash"></i></a></td>
                                                            </tr>
