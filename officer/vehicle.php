...
}else
{
    if($mile >= $max_mile)
    {
        ...
        echo '<script>alert(" Driven mileage should not be greater than maximum mileage.");window.location = "dash-officer.php";</script>';
        exit;
    ...
    }else
    {
        ...
        $command="
        INSERT INTO vehicle(officer_id,registration_no ,make,color,image, mileage, fueltype,description,dos,status) 
                    VALUES ('$id','$reg','$make','$color','".$upload_file."','$mile','$fuel','$cond','$dos','0')";
...
var errordos=document.getElementById("errordos");
 ...
 )
{
    ...
    errorcat.innerHTML="<span style='color:rgb(27,152,242);''>"+" Please select car condition. *</span>"
    errordos.innerHTML="<span style='color:rgb(27,152,242);''>"+" Please select last date of service. *</span>"
...
if(cat=="")
{
   ...
   errorcat.innerHTML="<span style='color:rgb(27,152,242);''>"+" Select car condition please!*</span>";
  return false;
...
//
var dos=document.forms["form"]["dos"].value;


if(dos=="")
{

   errordos.innerHTML="<span style='color:rgb(27,152,242);''>"+" Select  last date of service please!*</span>";
  return false;
...
<body style="background: rgb(255,255,255);font-family: Montserrat, sans-serif;">
    ...
    <div class="container" style="height: 477.676px;color: rgb(50,211,56);">
        ...
        <div class="d-flex flex-column justify-content-center" data-aos="fade-up-right" data-aos-delay="50" id="login-box">
            ...
            <input type="number" min="1"  step="0.1" class="email-imput form-control" style="margin-top: 10px;color:rgb(27,152,242);border-top-color: rgb(255,255,255);border-right-color: rgb(255,255,255);border-bottom-color: rgb(27,152,242);border-left-color: rgb(255,255,255);"  placeholder="Driven Mileage" name="mile" id="mile"><span id="errormile"></span>
            <input type="number" min="1" required step="0.1" class="email-imput form-control" style="margin-top: 10px;color:rgb(27,152,242);border-top-color: rgb(255,255,255);border-right-color: rgb(255,255,255);border-bottom-color: rgb(27,152,242);border-left-color: rgb(255,255,255);"  placeholder="Vehicle Max Mileage" name="max_mile" id="max_mile"></span>
            <select class="email-imput form-control" style="border-top-color: rgb(255,255,255);border-right-color: rgb(255,255,255);border-bottom-color: rgb(27,152,242);border-left-color: rgb(255,255,255);" name="fuel" id="fuel">
                ...
                </select><span id="errorfuel"></span>
            <select class="email-imput form-control" style="border-top-color: rgb(255,255,255);border-right-color: rgb(255,255,255);border-bottom-color: rgb(27,152,242);border-left-color: rgb(255,255,255);" name="cat" id="cat">
                    <option value="" selected="">Car Condition</option>
                    <option value="Poor">Poor</option>
                    <option value="Good">Good</option>
                    <option value="Excellent">Excellent</option>
                </select><span id="errorcat"></span>
            
                <input type="text"  onfocus="(this.type='date')" class="email-imput form-control" style="margin-top: 10px;color:rgb(27,152,242);border-top-color: rgb(255,255,255);border-right-color: rgb(255,255,255);border-bottom-color: rgb(27,152,242);border-left-color: rgb(255,255,255);" id="dos"  placeholder="last date of service" name="dos"><span id="errordos"></span>
            
            
            
            
            </div>
            <div class="submit-row" style="margin-bottom:8px;padding-top:0px;"><button class="btn btn-primary btn-block box-shadow"  value="upload" name="upload" type="submit" style="background: rgb(27,152,242);"> <i class="fas fa-plus-circle    "></i> Add</button></div>
            <div id="login-box-footer" style="padding: 10px 20px;padding-bottom: 23px;padding-top: 18px;background: rgb(27,152,242);">
                <p><a href="dash-officer.php" style="border-bottom-color: rgb(255,255,255);color: rgb(255,255,255);"><i class="fa fa-arrow-left"></i> Back</a></p>
            </div>
        </div>
    </div>
</form>
