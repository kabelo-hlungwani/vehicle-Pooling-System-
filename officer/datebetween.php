...
<body id="page-top">
    ...
    <br>
                    ...
                    <div class="container-fluid">
                        <div class="card shadow">
                            <div class="card-header py-3">
                                <p class="m-0 font-weight-bold" style="color:  rgb(27,152,242);">Report between ( <?php echo $datebegan; ?> and <?php echo $lastdate; ?> )</p>
                            </div>
              ...
              and vehicle.officer_id='$id'  AND date_Format(booking.booking_date,'%d-%m-%Y') BETWEEN '$newdate' AND '$ldate'";
...
<a class="btn btn" style="background-color:rgb(27,152,242);color:rgb(255,255,255)" href="report.php"> <i class="fa fa-arrow-left"></i> Back</a>
