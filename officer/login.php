...
$query="select * from fleet_officer where username='$username'and password='$password'";
...
echo '<script>alert("Login was successful.");window.location = "dash-officer.php";</script>';  
...
<script>
        ...
        uerror.innerHTML="<span style='color:rgb(27,152,242);''>"+" Username required *</span>"
        perror.innerHTML="<span style='color:rgb(27,152,242);''>"+" password required *</span>"
        ...
        uerror.innerHTML="<span style='rgb(27,152,242);''>"+" Username required *</span>"
    ...
    <div class="container" style="height: 477.676px;color: rgb(50,211,56);">
        ...
        <div class="d-flex flex-column justify-content-center" data-aos="fade-up-right" data-aos-delay="50" id="login-box">
            <div class="login-box-header" style="background: rgb(27,152,242);">
                <h4 style="color: rgb(255,255,255);margin-bottom: 0px;font-weight: 400;font-size: 27px;">Login(Fleet Officer)</h4>
            </div>
            <div class="login-box-content"></div>
            <div class="email-login" style="background-color:#ffffff;">
            <div><input type="text" name="username" id="username" class="email-imput form-control" style="margin-top: 10px;border-top-color: rgb(255,255,255);border-right-color: rgb(255,255,255);border-bottom-color: rgb(27,152,242);border-left-color: rgb(255,255,255);color: rgb(27,152,242);" placeholder="Username" ><span id="uerror"></span></div>
            <input type="password" id="password" name="password" class="password-input form-control" style="margin-top: 10px;border-top-color: rgb(255,255,255);border-right-color: rgb(255,255,255);border-bottom-color:rgb(27,152,242);border-left-color: rgb(255,255,255);color: rgb(27,152,242);" placeholder="Password" ><span id="perror"></span></div>
            <div class="submit-row" style="margin-bottom:8px;padding-top:0px;">
            <button class="btn btn-primary btn-block box-shadow" id="submit-id-submit" type="submit" name="login" style="background: rgb(27,152,242);">Login</button></div>
