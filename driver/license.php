...
if($row['license_no']==$license_no && $row['driver_id']==$id)
{

    echo '<script>alert("License information Exist.");window.location = "dash-driver.php";</script>';
...
$command="INSERT INTO driver_license_detail(driver_id,license_no,expiry_date) 
VALUES ('$id','$license_no','$expiry_date')";
...
echo '<script>alert("License information added.");window.location = "dash-driver.php";</script>';
            ...
            <div class="d-flex flex-column" id="content-wrapper">
                <div id="content">
                    <nav class="navbar navbar-light navbar-expand shadow mb-4 topbar static-top" style="background: #ffffff;">
                        <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button><a href="dash-driver.php" style="font-weight: 600;color: rgb(50,211,56);">Back To Account</a>
                                        ...
                                        <div class="card shadow mb-3">
                                            ...
                                            <div class="card-body">
                                                <form  action="" name="form" onsubmit="return validateForm();" method="post">
                                                    <div class="form-row">
                                                        <div class="col">
                                                            <div class="form-group"><label for="fname"><strong>License No.</strong></label><input class="form-control"  type="text" id="license_no" placeholder="License No" name="license_no"><span id="ferror"></span></div>
                                                        </div>
                                                        <div class="col">
                                                            <div class="form-group"><label for="mname"><strong>Expiry Date</strong><br></label><input class="form-control" type="text" onfocus="(this.type='date')"  id="expiry_date" placeholder="Expiry Date" name="expiry_date"><span id="lerror"></span></div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group"><button class="btn btn-sm" type="submit" name="send" style="background: rgb(50,211,56);color: rgb(255,255,255);">Save Information&nbsp;</button></div>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
