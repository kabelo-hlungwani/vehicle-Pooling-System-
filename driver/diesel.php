            ...
            <div class="d-flex flex-column" id="content-wrapper">
                <div id="content">
                    <nav class="navbar navbar-light navbar-expand shadow mb-4 topbar static-top" style="background: #ffffff;">
                        <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars" style="color: rgb(50,211,56);"></i></button><a href="tblcars.php" style="font-weight: 600;color: rgb(50,211,56);">Back To cars</a>
                            <ul class="navbar-nav flex-nowrap ml-auto">
                                ...
                                <li class="nav-item dropdown no-arrow">
                                    <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-toggle="dropdown"><span class="text-white d-none d-lg-inline mr-2 text-gray-600 small" style="color: rgb(50,211,56);font-size: 16px;">Filter</span><i class="fas fa-sort-amount-down" style="font-size: 28px;color: rgb(50,211,56);"></i></a>
                                        <div class="dropdown-menu shadow dropdown-menu-right animated--grow-in" style="font-size: 14px;text-align: left;"><a class="dropdown-item" href="petrol.php"><i class="fas fa-funnel-dollar fa-sm fa-fw mr-2 text-gray-400"></i>&nbsp;Petrol</a><a class="dropdown-item" href="diesel.php"><i class="fas fa-funnel-dollar fa-sm fa-fw mr-2 text-gray-400"></i>&nbsp;Diesel</a></div>
                                    </div>
                                </li>
                            </ul>
                            <ul class="navbar-nav flex-nowrap ml-auto">
              ...
              $query="SELECT * from vehicle where status='0' and fueltype='Diesel'";
                    ...
                    <div class="container-fluid" data-aos="fade-up-right">
                        <div class="card shadow">
                            <div class="card-header py-3">
                                <p class="m-0 font-weight-bold" style="color: rgb(50,211,56);">Cars Available(Diesel)</p>
                            </div>
                            <div class="card-body">
                            <?php
                  ...
                  ?>
                                <div class="gift row">
                                    <div class="gift__img col-sm-3 col-12"><img src="../officer/cars/<?php echo $rows['image']; ?>">
                                        <div class="gift__rating"><span class="gift__rating-number" style="color: rgb(118,118,118);font-weight: 600;font-family: Montserrat, sans-serif;">Vehicle#:&nbsp;</span><span class="gift__rating-number" style="color: rgb(65,204,0);font-weight: 600;font-family: Montserrat, sans-serif;"><?php echo $rows['vehicle_id'] ?></span></div>
                                    </div>
                                    <div class="gift__info col-sm-9 col-12">
                                        ...
                                        <div class="gift__bottom row">
                                            ...
                                            <div class="gift__cta-wrap col-12 col-sm-6"><a class="flux_cta gift__cta" href="DoBook.php?edt=<?php echo $rows['vehicle_id']?>" style="font-weight: 600;font-family: Montserrat, sans-serif;background: rgb(50,211,56);font-size: 15px;">Book</a></div>
                                        </div>
                                    </div>
                                </div>
                                <?php
