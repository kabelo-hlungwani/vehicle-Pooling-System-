...
echo '<script>alert("Information Updated.");window.location = "dash-driver.php";</script>';
                                    ...
                                    <div class="col">
                                        <div class="card shadow mb-3">
                                            <div class="card-header py-3">
                                                <p class="m-0 font-weight-bold" style="color: rgb(50,211,56);">User Information</p>
                                            </div>
                                            <div class="card-body">
                                                <form  action="" name="form" onsubmit="return validateForm();" method="post">
                                                    ...
                                                    <div class="form-group"><button class="btn btn-sm" type="submit" name="update" style="background: rgb(50,211,56);color: rgb(255,255,255);">Save Information&nbsp;</button></div>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
