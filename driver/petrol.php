            ...
            <div class="d-flex flex-column" id="content-wrapper">
                <div id="content">
                    <nav class="navbar navbar-light navbar-expand shadow mb-4 topbar static-top" style="background: #ffffff;">
                        <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars" style="color: rgb(50,211,56);"></i></button><a href="tblcars.php" style="font-weight: 600;color: rgb(50,211,56);">Back cars</a>
              ...
              $query="SELECT * from vehicle where status='0' and fueltype='Petrol'";
                    ...
                    <div class="container-fluid" data-aos="fade-up-right">
                        <div class="card shadow">
                            <div class="card-header py-3">
                                <p class="m-0 font-weight-bold" style="color: rgb(50,211,56);">Cars Available(Petrol)</p>
                            </div>
                            <div class="card-body">
                            <?php
