...
<body id="page-top">
        ...
        <div id="wrapper">
            <div class="d-flex flex-column" id="content-wrapper">
                    ...
                    <div class="container-fluid">
                        <div class="card shadow">
                            <div class="card-header py-3">
                                <p class="m-0 font-weight-bold" style="color:  rgb(50,211,56);">My bookings</p>
                            </div>
              ...
              $query="SELECT * from booking,vehicle where booking.driver_id='$id' and booking.approved='1' and booking.vehicle_id=vehicle.vehicle_id and del='0' and vehicle.status='1' ";
                                                ...
                                                <div class="table-responsive table-bordered table table-hover table-bordered results">
                                                    <table class="table table-bordered table-hover">
                                                        <thead class="bill-header cs" style="background: rgb(50,211,56);">
                                                            <tr>
                                                                <th id="trs-hd" class="col-lg-1">booking#</th>
                                                                ...
                                                                <th id="trs-hd" class="col-lg-2"><br>Booking Status<br></th>
                                                         
                                                                <th id="trs-hd" class="col-lg-2">End Trip</th>
                                                        ...
                                                        <tbody>
                                                          ...
                                                          ?>
                                                            <tr>
                                                                ...
                                                                <td><img src="../officer/cars/<?php echo $rows['image'];?>" style="width: 150px;height:75px;"></td>
                                                             ...
                                                             <td>
                                                                <a class="btn btn-danger btn-sm border-white" href="cancelbooking.php?edt=<?php echo $rows['booking_id'];?>" style="margin-left: 5px;background:rgb(50,211,56);" type="submit">complete trip</a></td>
                                                            </tr>
