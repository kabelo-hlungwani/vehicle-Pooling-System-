        ...
        <div id="wrapper">
            <div class="d-flex flex-column" id="content-wrapper">
                ...
                <nav class="navbar navbar-light navbar-expand shadow mb-4 topbar static-top" style="background: #ffffff;">
                        <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button><a href="report.php" style="font-weight: 600;color:rgb(21,132,38);">Back </a>
                    ...
                    <div class="container-fluid">
                        <div class="card shadow">
                            <div class="card-header py-3">
                                <p class="m-0 font-weight-bold" style="color: rgb(21,132,38);">Report of vehicle #<?php echo $v; ?></p>
                            </div>
...
<p style="text-align:center;">
            <button class="btn btn-primary" style="background-color:rgb(21,132,38)" onclick="$('table').table2csv();">Export csv</button>
            <button class="btn btn-primary" style="background-color:rgb(21,132,38)"onclick="$('table').wordExport({font:20});">Export Doc</button>
            <button class="btn btn-primary" style="background-color:rgb(21,132,38)"onclick="$('table').tblToExcel();">Export xls</button>
            <button class="btn btn-primary" style="background-color:rgb(21,132,38)" onclick="myApp.printTable()">Print</button>
