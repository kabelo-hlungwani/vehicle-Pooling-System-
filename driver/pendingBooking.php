    ...
    <div class="container">
        <div id="wrapper">
            <div class="d-flex flex-column" id="content-wrapper">
                    ...
                    <div class="container-fluid">
                        <div class="card shadow">
                            <div class="card-header py-3">
                                <p class="m-0 font-weight-bold" style="color:  rgb(50,211,56);">My pending bookings</p>
                            </div>
              ...
              $query="SELECT * from booking,vehicle where booking.driver_id='$id' and booking.approved='0' and booking.vehicle_id=vehicle.vehicle_id and del='0'";
                                                        ...
                                                        <tbody>
                                                          ...
                                                          ?>
                                                            <tr>
                                                                ...
                                                                <td><?php if($rows['approved']=='1'){ echo $mes='Approved.';}else{echo $mes='Pending';};  ?></td>
                                                                <td><a class="btn btn-danger btn-sm border-white"  title="Edit booking" href="editBooking.php?edt=<?php echo $rows['booking_id'];?>" style="margin-left: 5px;background: rgb(50,211,56);" type="submit"><i class="fa fa-edit"></i></a><br>
                                                                <a class="btn btn-danger btn-sm border-white"  title="cancel booking" href="deleteBooking.php?edt=<?php echo $rows['booking_id'];?>" style="margin-left: 5px;background: rgb(50,211,56);" type="submit"><i class="fa fa-trash"></i></a></td>
                                                            </tr>
